...
class Lecturer(models.Model):
    ...
    first_name = models.CharField(max_length=200, help_text="Please Enter Lecturer First Name")
    last_name = models.CharField(max_length=200, help_text="Please Enter Lecturer Last Name")
    phone_number = models.CharField(max_length=13, validators=[validate_kenyan_phone_number], help_text="Enter phone number in the format 0798073204 or +254798073404")
