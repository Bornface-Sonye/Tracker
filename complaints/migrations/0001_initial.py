# Generated by Django 4.2.7 on 2024-11-01 18:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Complaint',
            fields=[
                ('complaint_code', models.CharField(help_text='Please Enter Complaint Code', max_length=100, primary_key=True, serialize=False)),
                ('missing_mark', models.CharField(choices=[('CAT', 'CAT'), ('EXAM', 'EXAM'), ('ALL', 'ALL')], max_length=20)),
                ('exam_date', models.DateField()),
                ('complainant', models.CharField(help_text='Please Enter Complainant Role', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exam', models.CharField(blank=True, max_length=3, null=True)),
                ('date', models.DateField(default=django.utils.timezone.now)),
                ('complaint_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='complaints.complaint')),
                ('reg_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='complaints.student')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('complaint_code', models.CharField(max_length=100)),
                ('missing_mark', models.CharField(choices=[('CAT', 'CAT'), ('EXAM', 'EXAM'), ('ALL', 'ALL')], max_length=20)),
                ('exam_date', models.DateField()),
                ...
                ('academic_year', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='complaints.academicyear')),
                ('reg_no', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='complaints.student')),
                ('unit_code', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='complaints.unit')),
            ],
        ),
    ]
